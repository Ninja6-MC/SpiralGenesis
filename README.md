...
| `/sgen release-all confirm` | Release the spawn claim around every player's current plot, for uninstalling. Refused under `PLAYER_CLAIM`. See [Uninstalling](docs/ADMIN_GUIDE.md#11-uninstalling). |
